...
const Contact = () => {
  ...
  <img data-aos="fade-up" className="w-auto h-auto" src="https://img.freepik.com/free-vector/customer-support-flat-illustration_23-2148889375.jpg?t=st=1721841000~exp=1721844600~hmac=8091985bdaf46b87d8ca8030155402e7dac445fba3896a3c94db3a708e5f5ec6&w=360" />
</div>
      <div className="max-w-5xl max-lg:max-w-3xl py-5 mx-auto bg-white  font-[sans-serif] mb-5">
            <div className="text-center px-6 ">
                <h2  className="text-cyan-800 text-3xl font-extrabold">Contact Us</h2>
                <p data-aos="zoom-in" className="text-sm text-gray-500 mt-4 italic">Have any issue or need help or any technical support?</p>
            </div>

            <div data-aos="flip-up" className="grid lg:grid-cols-3 items-start gap-4 p-2 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-lg mt-12">

                <div className="bg-[#011c2b] rounded-lg p-6 h-full max-lg:order-1">
                    <h2 className="text-xl text-white">Contact Information</h2>
                    <p className="text-sm text-gray-300 mt-4">Have any issue or need help or any technical support?</p>

                    <ul data-aos="fade-down" className="mt-16 space-y-8">
                        <li  className="flex items-center">
                            ...
                            <a  className="text-sm text-gray-500 ml-4">
                                cityhospital10@gmail.com
                            </a>
                        </li>
                        <li className="flex items-center">
                ...
                <div className="p-4 lg:col-span-2">
                    <form>
                                ...
                                <div className="flex max-lg:flex-col gap-6 mt-4">
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        <label htmlFor="radio2"
                                            className="relative p-0.5 flex items-center justify-center shrink-0 peer-checked:before:hidden before:block before:absolute before:w-full before:h-full before:bg-white w-5 h-5 cursor-pointer border-2 border-[#011c2b] rounded-full overflow-hidden">
                                            <span className="border-[4px] border-[#1f3f50] rounded-full w-full h-full"></span>
                                        </label>
                        ...
                        <button type="button"
                            className="mt-12 flex items-center justify-center text-sm lg:ml-auto max-lg:w-full rounded-lg px-4 py-3 tracking-wide text-white bg-cyan-800 hover:bg-cyan-700">
