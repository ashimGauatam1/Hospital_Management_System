     ...
     <div className="font-[sans-serif] bg-white md:h-screen ">
      <div className="grid md:grid-cols-2 items-center gap-8 h-full ">
        <div data-aos='zoom-out-right' className="max-md:order-1 p-4 mt-10">
          <img src="https://img.freepik.com/free-vector/private-healthcare-abstract-concept-vector-illustration-private-medicine-healthcare-insurance-paid-medical-services-health-center-specialist-consulting-clinic-facility-abstract-metaphor_335657-1543.jpg?t=st=1721715047~exp=1721718647~hmac=87f415cdba146a6837afa3ef2de934192e3070308b1a5b3f29db2811108fe88e&w=360" className="lg:max-w-[85%] w-full h-full object-contain block mx-auto" alt="login-image" />
        </div>
          ...
          <form className="max-w-lg w-full mx-auto mt-20">
            ...
            <div>
              ...
              <div className="relative flex items-center">
                <input name="name" onChange={handlechange} type="text" required className="w-full bg-transparent text-sm text-white border-b border-gray-300 focus:border-yellow-400 px-2 py-3 outline-none" placeholder="Enter name" />
            ...
            <div className="mt-8">
              ...
              <div className="relative flex items-center">
                <input name="email"  onChange={handlechange} type="text" required className="w-full bg-transparent text-sm text-white border-b border-gray-300 focus:border-yellow-400 px-2 py-3 outline-none" placeholder="Enter email" />
            ...
            <div className="mt-8">
              ...
              <div className="relative flex items-center">
                <input name="password"  onChange={handlechange} type="password" required className="w-full bg-transparent text-sm text-white border-b border-gray-300 focus:border-yellow-400 px-2 py-3 outline-none" placeholder="Enter password" />
            ...
            <div className="mt-12">
              <button  onClick={fetchuser} type="button" className="w-max shadow-xl py-3 px-6 text-sm text-gray-800 font-semibold rounded-md bg-transparent bg-yellow-400 hover:bg-yellow-700 hover:text-white focus:outline-none">
                Register
              </button>
