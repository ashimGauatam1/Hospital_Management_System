      ...
      <div className="grid md:grid-cols-2 items-center gap-8 h-full ">
        ...
        <div data-aos="fade-up-left" className="flex items-center md:p-8 p-6 bg-cyan-700 rounded-sm h-full lg:w-11/12 lg:ml-auto">
          ...
          <form className="max-w-lg w-full mx-auto mt-20">
            ...
            <div className="mt-12">
              <button type="button" className="w-max shadow-xl py-3 px-6 text-sm text-gray-800 font-semibold rounded-md bg-transparent bg-yellow-400 hover:bg-yellow-700 hover:text-white focus:outline-none">
                Register
              </button>
